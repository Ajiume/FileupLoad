...
if(typeof(KindEditor) != "undefined") {
	KindEditor.ready(function(K) {
		editor = K.create("#editor", {
			...
			uploadJson: rysoft.base + "/admin/file!ajaxUpload.action",
			fileManagerJson: rysoft.base + "/admin/file!ajaxBrowser.action",
...
function currencyFormat(price) {
	price = setScale(price, rysoft.priceScale, rysoft.priceRoundType);
	return rysoft.currencySign + price + rysoft.currencyUnit;
}
